package com.example.drivinglicenseexamnepal_.viewmodel


import androidx.lifecycle.ViewModel
import com.example.drivinglicenseexamnepal_.data.model.Question
import com.example.drivinglicenseexamnepal_.data.questions.getBikeQuestionsA
import com.example.drivinglicenseexamnepal_.data.questions.getBikeQuestionsB
import com.example.drivinglicenseexamnepal_.data.questions.getBikeQuestionsC
import com.example.drivinglicenseexamnepal_.data.questions.getBikeQuestionsD
import com.example.drivinglicenseexamnepal_.data.questions.getBikeQuestionsE
import com.example.drivinglicenseexamnepal_.data.questions.getCarQuestionsA
import com.example.drivinglicenseexamnepal_.data.questions.getCarQuestionsB
import com.example.drivinglicenseexamnepal_.data.questions.getCarQuestionsC
import com.example.drivinglicenseexamnepal_.data.questions.getCarQuestionsD
import com.example.drivinglicenseexamnepal_.data.questions.getCarQuestionsE
import com.example.drivinglicenseexamnepal_.data.questions.getCommonQuestions
